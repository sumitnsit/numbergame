...
window.onload = function(){
	...
	$$("playerName").addEventListener("onchange", function(){
		eventController.dispatchEvent(new Event("changeUsername"));
	}, false);

	$$("playerName").value = storage.getUser();
